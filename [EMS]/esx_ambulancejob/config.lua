...
Config.Blip = {
	Pos     = { x = 364.49560546875, y = -591.08605957031, z = 28.687181472778 },
	Sprite  = 61,
	Display = 4,
	Scale   = 1.2,
	Colour  = 2,
...
Config.Zones = {
	...
	HospitalInteriorInside1 = {
		Pos	= { x = 357.48, y = -570.99, z = 28.79 }, --Respawn
		Type = -1
	},
	...
	Pharmacy = {
		Pos	= { x = 330.80944824219, y = -581.01678466797, z = 27.791475296021 },
		Type = 1
	},
